...
namespace Tokyo {
    ...
    class ObstaclesState : public State {
    public:
        ObstaclesState(GameDataRef data , PlayerType playerType, bool isMute);
        ...
        std::shared_ptr<ObstaclesTTT_Board> _obstaclesBoard;
        sf::Clock _clock;
        ...
        std::unique_ptr<sf::Sprite> _obs1;
        std::unique_ptr<sf::Sprite> _obs2;
