...
/**
 * @brief Constructor for the TTT5x5_UI.
 * Calls the base constructor with the game's welcome message and sets the cell width to 3 characters.
 */
TTT5x5_UI::TTT5x5_UI() : UI("\nWelcome to Tic-Tac-Toe (5x5)!\nGet 3 in a row to earn points. Get more points to win!\n", 3) {}

/**
 * @brief Sets up two players for the 5x5 game.
